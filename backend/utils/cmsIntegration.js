...
<p><em>Generated by AI Content Creator - Optimized for ${cleanTargetAudience}</em></p>`;
      ...
      // Build the item data based on collection fields
      const itemData = {
        isArchived: false,
        isDraft: false,
        fieldData: {
      ...
      const fieldMappings = {
        ...
        'post-summary': cleanDescription.substring(0, 150),
        'meta-title': cleanTitle,
        'meta-description': cleanDescription.substring(0, 160),
        'seo-title': cleanTitle,
        'seo-description': cleanDescription.substring(0, 160),
      ...
      // Apply field mappings to fieldData
      Object.keys(fieldMappings).forEach(key => {
        itemData.fieldData[key] = fieldMappings[key];
      });

      console.log(`Publishing item data to collection ${blogCollection.id}:`, JSON.stringify(itemData, null, 2));
